...
<main id="main-content">
  ...
  <article class="ds-body">
    ...
    <p>By 2022, it purchased the components necessary to monitor and intercept the everyday communications of citizens, store that data centrally, <strong>and ensure access by various law enforcement agencies, documents show.&nbsp;&nbsp;</strong></p>
  ...
  <article class="ds-body">
    ...
    <p>Import data obtained by this newspaper begins with the purchase of a radio frequency jammer by Rab in 2016, from <strong>Samel 90, a Bulgarian electronics and defence manufacturer.</strong>&nbsp;</p>
    ...
    <p>Import data show that the police bought more IMSI catchers – one of them bike-mounted – in 2019 and 2022 from <strong>Canadian firm Octasic</strong>. In total, the police spent Tk 43 crore on IMSI catchers, signifying police's dependence on such snooping devices.&nbsp;</p>
    ...
    <p>Rab, on the other hand, armed itself with a backpack IMSI catcher and two units of unspecified mobile communication analysers from <strong>Octasic.</strong> These analysers can generally track which devices are connecting to which networks, their unique identification numbers, phone numbers, locations, and collect information on call logs and text messages.&nbsp;</p>
